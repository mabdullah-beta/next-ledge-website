...
import { ArrowRight, Star, TimerIcon, ShieldCheck, CheckCircle2, BarChart3, TrendingUp, Database, Zap, Users, Target, Award, Lightbulb, FileSpreadsheet, PieChart, Activity, Building2, Settings, LineChart, CheckCircle, Cpu } from "lucide-react";
                    ...
                    <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
                        <FadeUp>
                            ...
                            <p className="text-[15px] sm:text-[16px] md:text-[17px] lg:text-[19px] font-inter font-normal text-white/80 leading-relaxed mt-6 max-w-3xl mx-auto">
                                Transformeer uw bedrijf met geavanceerde automatisering, business intelligence en 
                                AI-gedreven oplossingen voor optimale financiële processen.
                            </p>
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
                                ...
                                <div className="flex items-center gap-2 text-white/80">
                                    <CheckCircle size={16} />
                                    <span className="text-sm">Datagedreven oplossingen</span>
                                </div>
                            </div>
                        </FadeUp>
                    </div>
